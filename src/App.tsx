...
export const App: React.FC = () => {
  ...
  // The browser tab / share title carries the cafe's name from the database;
  // index.html only ships a generic fallback until the first sync arrives.
  useEffect(() => {
    document.title = `${cafe.name} - QR Ordering & Kitchen System`;
  }, [cafe.name]);
