...
class StorageService {
  ...
  // --- CAFE INFO ---
  // The cafe row in the database is the single source of truth for the cafe's
  // identity (id, name, tagline, ...). localStorage only caches the last copy
  // fetched from /cafe so the UI has something to render before the first
  // sync completes; nothing here may rewrite what the server sent.
